...
$1.4\cdot 10^{-7} \pm 3\cdot 10^{-8}$& 120& 1\\
$5\cdot 10^{-6} \pm 1\cdot 10^{-6}$& 190& 1\\
$9\cdot 10^{-6} \pm 2\cdot 10^{-6}$& 230& 1\\\midrule
$1.9\cdot 10^{-7} \pm 5\cdot 10^{-8}$& 120& 2\\
$6\cdot 10^{-6} \pm 2\cdot 10^{-6}$& 190& 2\\
$1.0\cdot 10^{-5} \pm 2\cdot 10^{-6}$& 230& 2\\ \midrule
$2.2\cdot 10^{-7} \pm 5\cdot 10^{-8}$& 120& 5\\
$9\cdot 10^{-6} \pm 2\cdot 10^{-6}$ & 190& 5\\ 
$1.7\cdot 10^{-5} \pm 4\cdot 10^{-6}$ & 230& 5\\\midrule
$1.3\cdot 10^{-6} \pm 3\cdot 10^{-7}$& 120& 10\\ 
$2.0\cdot 10^{-5} \pm 5\cdot 10^{-6}$ & 190& 10\\
$3.2\cdot 10^{-5} \pm 8\cdot 10^{-6}$ & 230& 10\\ \bottomrule
\end{tabular}
...
\end{table}
From the Mach number we can see that we are indeed in the supersonic regime. The errors in the table were estimated with the error on the length $d$, which is the biggest source of uncertainty. Therefore we fitted the data first using the lower bound $d = 27$ cm, then again with the upper bound $d= 33$ cm, and we averaged the two results of the two fits, so we wrote the error as the relative distance divided by two.
