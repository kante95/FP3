...
\begin{figure}[H]
  ...
  \caption{Depiction of Angiotensin. The image was taken from Pubchem \cite{pubchem}. }
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width = 0.6 \textwidth]{humblespectrum.png}
  \caption{ESI spectrum of Angiotensin over a wide $m/z$ range. }
\end{figure}
