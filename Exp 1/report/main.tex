...
%something about SORI

\section{Analysis}

\subsection{High resolution mass spectrum}
At the beginning of the experiment we had to record a high-resolution mass spectrum of Angiotensin with two additional protons attached to it (\ch{C62H93N17O14^{3+}}). According to the Universal Mass Calculator \cite{umc}, this should yield an average $m/z$ ratio of \num{433.167}. This is only an average because in reality one would expect multiple peaks for different isotope combinations as one can see in Fig. \ref{fig_hres_spectroscopy}.
...
In this part of the experiment we produced fragments by means of CID. We analyzed the spectrum produced by the fragments with different collision energy. %1018298
