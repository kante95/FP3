...
c = np.array([131.11, 287.296, 386.427, 549.6, 662.758, 897.013, 1044.187, 1181.327])
...
def find(arr1, arr2, aim):
    ...
    for i in range(0,len(arr1)):
        for j in range(0,len(arr2)):
            ...
            if (np.abs(mint - aim) < 2):
                print(str(mint) + " c_" + str(i+1) + " z_" + str(j+1))
# end
aim = np.array([110.07, 247.6, 292.08, 297.11, 506.27, 583.3, 619.35, 1056.03, 1099.32, 594.22, 1012.54, 1238.7, 1166.6])
for i in aim:
    find(c, z, i)
"""